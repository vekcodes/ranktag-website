...
import { db, visibleWhere } from '../_lib/db.js';
...
export default async function handler(req, res) {
  try {
    ...
    const sql = db();
    // See visibleWhere() in _lib/db.js: falls back to the pre-scheduling
    // condition if publish_at is absent, so this never errors into no posts.
