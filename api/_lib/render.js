...
.prose img{display:block;max-width:100%;height:auto;margin:1.6em auto;
...
.feat{display:grid;grid-template-columns:1.1fr .9fr;align-items:center;background:#fff;
